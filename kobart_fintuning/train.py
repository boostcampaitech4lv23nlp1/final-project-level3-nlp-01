...
class ArgsBase():
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--train_file',
                            type=str,
                            # default='/opt/ml/data/summary/report_generation/tsv/colloquial/20per/train.tsv',
                            default='/opt/ml/data/summary/all_preprocessed/tsv_without_news/train.tsv',
                            help='train file')

        parser.add_argument('--test_file',
                            type=str,
                            # default='/opt/ml/data/summary/report_generation/tsv/colloquial/20per/test.tsv',
                            default='/opt/ml/data/summary/all_preprocessed/tsv_without_news/test.tsv',
                            help='test file')
...
if __name__ == '__main__':
    ...
    datamodule = KobartSummaryModule(args.train_file,
                        args.test_file,
                        tokenizer,
